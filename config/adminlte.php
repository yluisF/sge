...
return [
    ...
    */
    ...
    'menu' => [
        [
            'text' => 'Buscar Afiliado del Partido Politico',
            'search' => false,
            'topnav' => true,
        ],
        [
        ...
        [
            ...
            'route'  => 'registrodireccion',//ruta de regsitor ubicacion
            'icon'  => 'fas fa-map-marked-alt',
        ],
        ['header' => 'Busquedas'],
        [
            'text'       => 'Busqueda por Seccón',
            'icon_color' => 'red',
            'route'        => 'seccion',
        ],
        [
            'text'       => 'Busqueda por Jerarquías',
            'icon_color' => 'yellow',
            'route'        => 'cargos',
        ],
        [
            'text'       => 'Busqueda por Municipios',
            'icon_color' => 'cyan',
           'route'        => 'municipio',
        ],
        [
            'text'       => 'Busqueda por Colonias',
            'icon_color' => 'green',
            'route'        => 'colonia',
        ],
    ],
